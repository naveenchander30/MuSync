  ...
  const features = [
    {
      ...
      description: 'Move your entire music library between Spotify and YouTube Music in minutes'
    },
    {
      icon: '🔄',
      title: 'Smart Matching',
      description: 'Advanced fuzzy matching ensures your tracks are found across platforms'
    },
    {
      icon: '📊',
      title: 'Real-Time Progress',
      description: 'Watch your sync happen live with detailed progress tracking and logs'
    },
    {
      icon: '🔒',
      title: 'Secure & Private',
      description: 'OAuth authentication with official APIs - your data never leaves your device'
    },
    {
      icon: '💾',
      title: 'Backup & Export',
      description: 'Save your playlists locally as JSON for safekeeping and portability'
    },
    {
      icon: '⚡',
      title: 'Lightning Fast',
      description: 'Batch processing and background tasks make transfers blazing fast'
    }
  ]
  ...
  const howItWorks = [
    {
      ...
      description: 'Authenticate with Spotify and YouTube Music using secure OAuth'
    },
    {
      step: '2',
      title: 'Choose Your Action',
      description: 'Export from one platform or import to another - you control the flow'
    },
    {
      step: '3',
      title: 'Track Progress',
      description: 'Watch real-time updates as your music transfers, with full visibility'
    }
  ]
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-24 md:py-32">
          <div className="text-center space-y-8">
            ...
            <p className="text-xl md:text-2xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
              Move your music library from <span className="text-primary font-semibold">Spotify</span> to <span className="text-red-500 font-semibold">YouTube Music</span> and back. 
      ...
      <div className="max-w-7xl mx-auto px-6 py-24">
        <div className="text-center mb-16">
          ...
          <p className="section-subtitle">
            Everything you need to keep your music library in sync across platforms
          </p>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-24">
        <div className="card bg-gradient-to-r from-primary/20 via-accent-purple/20 to-accent-pink/20 border-primary/30 text-center glow-primary">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Join thousands of users who trust MuSync to keep their music library synchronized across platforms.
          </p>
          <button 
            onClick={onGetStarted}
